...
export class Cart {
  ...
  getOrders() { return AuthService.getOrdersByState('ordered'); }
  getArrivedOrders() { return AuthService.getOrdersByState('arrived'); }
  getCanceledOrders() { return AuthService.getOrdersByState('cancelled'); }
  ...
  // NOVO: Brisanje pristiglih (zahtev iz teksta)
